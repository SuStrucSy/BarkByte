...
export const PendingSpecimensApprovePendingSpecimenBody = zod.object({
...
export const PendingSpecimensRejectPendingSpecimenRouteBody = zod.object({
  "comment_by_reviewer": zod.string()
}).describe('Body for approve or reject actions.')
...
export const PendingSpecimensUpdatePendingSpecimenBody = zod.object({
  "comment_by_author": zod.union([zod.string(),zod.null()]).optional(),
...
export const PendingSpecimensListPendingSpecimensQueryParams = zod.object({
  "status": zod.union([zod.enum(['pending', 'approved', 'rejected']),zod.null()]).optional()
})

export const PendingSpecimensListPendingSpecimensResponse = zod.object({
  "pending_specimens": zod.array(zod.object({
  "comment_by_author": zod.union([zod.string(),zod.null()]).optional(),
  "specimen_id": zod.union([zod.uuid(),zod.null()]).optional(),
  "changed_by_user_id": zod.uuid(),
  "changed_data": zod.record(zod.string(), zod.unknown()),
...
export const PendingSpecimensListApprovedSpecimenTrailResponse = zod.object({
  "pending_specimens": zod.array(zod.object({
  "comment_by_author": zod.union([zod.string(),zod.null()]).optional(),
  "specimen_id": zod.union([zod.uuid(),zod.null()]).optional(),
  "changed_by_user_id": zod.uuid(),
