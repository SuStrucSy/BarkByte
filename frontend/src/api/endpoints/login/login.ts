...
export const getLoginLoginAccessTokenMutationOptions = <TError = ErrorType<void | HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginLoginAccessToken>>, TError,{data: BodyLoginLoginAccessToken}, TContext>, }
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type LoginLoginAccessTokenMutationError = ErrorType<void | HTTPValidationError>

    /**
 * @summary Login Access Token
 */
export const useLoginLoginAccessToken = <TError = ErrorType<void | HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginLoginAccessToken>>, TError,{data: BodyLoginLoginAccessToken}, TContext>, }
...
export const loginTestToken = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/v1/login/test-token`, method: 'POST', signal
    },
      );
    }
...
export const getLoginTestTokenMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginTestToken>>, TError,void, TContext>, }
 ...
 * @summary Test Token
 */
export const useLoginTestToken = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginTestToken>>, TError,void, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
...
export const loginRecoverPassword = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/v1/password-recovery/${email}`, method: 'POST', signal
    },
      );
    }
...
export const getLoginRecoverPasswordMutationOptions = <TError = ErrorType<HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginRecoverPassword>>, TError,{email: string}, TContext>, }
 ...
 * @summary Recover Password
 */
export const useLoginRecoverPassword = <TError = ErrorType<HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginRecoverPassword>>, TError,{email: string}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
...
export const loginResetPassword = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<Message>(
      {url: `/api/v1/reset-password/`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: newPassword, signal
    },
      );
    }
...
export const getLoginResetPasswordMutationOptions = <TError = ErrorType<void | HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginResetPassword>>, TError,{data: NewPassword}, TContext>, }
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type LoginResetPasswordMutationError = ErrorType<void | HTTPValidationError>

    /**
 * @summary Reset Password
 */
export const useLoginResetPassword = <TError = ErrorType<void | HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginResetPassword>>, TError,{data: NewPassword}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
